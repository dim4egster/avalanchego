...
// Client interface for Qmall Indexer API Endpoint
...
// Client implementation for Qmall Indexer API Endpoint
type client struct {
...
// For example:
//   - http://1.2.3.4:4960/ext/index/C/block
//   - http://1.2.3.4:4960/ext/index/X/tx
