...
import (
	...
	"github.com/dim4egster/qmallgo/api/admin"
	"github.com/dim4egster/qmallgo/api/auth"
	...
	"github.com/dim4egster/qmallgo/indexer"
	...
	ipcsapi "github.com/dim4egster/qmallgo/api/ipcs"
)
...
// Node is an instance of an Qmall node.
type Node struct {
	Log        logging.Logger
...
// initVMs initializes the VMs Qmall supports + any additional vms installed as plugins.
func (n *Node) initVMs() error {
	...
	// Register the VMs that Qmall supports
	errs := wrappers.Errs{}
	errs.Add(
