...
import (
	...
	xchaintxs "github.com/dim4egster/qmallgo/vms/avm/txs"
	pchaintxs "github.com/dim4egster/qmallgo/vms/platformvm/txs"
)
...
//
// Since an Qmall network has exactly one Platform Chain, and the Platform
...
func FromConfig(config *Config) ([]byte, ids.ID, error) {
	...
	}
	{
		...
		avmArgs.GenesisData = map[string]avm.AssetDefinition{
			"QMALL": avax, // The AVM starts out with one asset: QMALL
		}
	}
	...
	if err != nil {
		return nil, ids.ID{}, fmt.Errorf("couldn't generate QMALL asset ID: %w", err)
	}
