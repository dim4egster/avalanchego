...
// Note that since an Qmall network has exactly one Platform Chain,
...
// BuildGenesis build the genesis state of the Platform Chain (and thereby the Qmall network.)
