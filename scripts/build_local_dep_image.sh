...
echo "Building docker image based off of most recent local commits of qmallgo and coreth"

AVALANCHE_REMOTE="git@github.com:dim4egster/qmallgo.git"
CORETH_REMOTE="git@github.com:dim4egster/coreth.git"
DOCKERHUB_REPO="avaplatform/qmallgo"
...
AVALANCHE_CLONE="$WORKPREFIX/qmallgo"
...
AVALANCHE_COMMIT_HASH="$(git -C "$EXISTING_GOPATH/$AVA_LABS_RELATIVE_PATH/qmallgo" rev-parse --short HEAD)"
